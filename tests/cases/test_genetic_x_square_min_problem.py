...
def x_square_min_problem(individuals: np.ndarray) -> np.ndarray:
    """
...
def test_x_square_min_problem():
    """
    测试 x_square_min_problem 函数
    该函数用于测试遗传算法在一维最小化问题上的表现
    """
    # 初始化遗传算法参数
    ...
    # 执行算法迭代
    best_fitness_values = genetic_algorithm.start_iterating(objective_function=x_square_min_problem)

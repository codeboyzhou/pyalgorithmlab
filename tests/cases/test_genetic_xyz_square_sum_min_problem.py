...
def xyz_square_sum_min_problem(individuals: np.ndarray) -> np.ndarray:
    """
...
def test_xyz_square_sum_min_problem():
    """
    测试 xyz_square_sum_min_problem 函数
    该函数用于测试遗传算法在三维最小化问题上的表现
    """
    # 初始化遗传算法参数
    ...
    # 执行算法迭代
    best_fitness_values = genetic_algorithm.start_iterating(objective_function=xyz_square_sum_min_problem)

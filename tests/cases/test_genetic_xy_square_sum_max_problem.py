...
def xy_square_sum_max_problem(individuals: np.ndarray) -> np.ndarray:
    """
...
def test_xy_square_sum_max_problem():
    ...
    # 执行算法迭代
    best_fitness_values = genetic_algorithm.start_iterating(objective_function=xy_square_sum_max_problem)
